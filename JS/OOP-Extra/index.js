class Character {
  ...
  attack(enemy) {
    let newEnemyHealth = enemy.getHealth() + enemy.defense - this.strength;
    enemy.setHealth(newEnemyHealth);
  }
  receiveDamage(damage) {
    let healthAfterDamage = this.getHealth() - damage;
  ...
  displayStats() {
    console.log(`Status name : ${this.name}`);
    console.log(`Status health: ${this.getHealth()}`);
    console.log(`Status strength : ${this.strength}`);
    console.log(`Status defense : ${this.defense}`);
  }
  characterType() {
